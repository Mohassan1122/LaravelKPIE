...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
     ...
     <title>Connect quicker with Raktapp</title>
 <link rel="shortcut icon" href="../IMAGES/favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('CSSs/index.css') }}">
...
<body class="bg-light">
            ...
            <header class="blog-header">
              <div class="row flex-nowrap justify-content-between align-items-center">
                <div class="col-4 pt-2">
                  <a class="blog-header-logo p-5 " href="{{ url('/') }}">RAKTAPP</a>
                </div>
                <div class="col-4 d-flex justify-content-end align-items-center">
                    <div class="dropdown">
                        <a class="text-dark style" href="#" data-toggle="dropdown" >Language</a>
    ...
    <script src="{{ asset('CSSs/bootstrap-5.0.2-dist/js/bootstrap.bundle.min.js') }}"></script>
